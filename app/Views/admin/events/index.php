...
<div class="container py-4">
    <h2>Eventos</h2>
    <a href="<?= base_url('admin/events/create'); ?>" class="btn btn-primary mb-3">Novo Evento</a>
            ...
            <tbody>
                <?php foreach ($events as $event): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('admin/events/view/' . $event['id_e']) ?>" title="Visualizar" class="btn btn-sm btn-outline-secondary me-1">
