...
$routes->group($pre, function($routes) {
    $routes->get('certificate', 'Home::certificate');
    $routes->get('certificate/(:any)', 'Home::made_certificate/$1');
    $routes->get('certificateO/(:any)', 'Home::made_certificate_other/$1');
    $routes->get('certificate/import', 'Home::form_events');
    $routes->post('certificate/import', 'Home::form_events');    
});
